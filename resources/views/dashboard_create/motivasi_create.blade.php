...
@section('title', 'Motivasi Create | Cov.id')
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Add Motivasi</strong>
                        </div>
                        <div class="card-body">
                            <form action="/motivasi" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-md btn-info btn-block">Tambah Motivasi</button>
                                </div>
